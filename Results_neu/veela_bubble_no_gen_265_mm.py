...
for w in wind_ref:
    ...
    #name = 'veela_bubble_no_gen_265_mm_u_ref_' + str(w[0]) + '_log_wind_n_k_' + str(w[1])
    name = 'veela_bubble_no_gen_265_mm_u_ref_' + str(w) + '_log_wind_n_k_42'
    ...
    options['solver']['max_cpu_time'] = 1e4
