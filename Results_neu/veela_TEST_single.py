...
for w in wind_ref:
    ...
    name = 'veela_single_no_gen_265_mm_u_ref_' + str(w) + '_log_wind'
...
for w in wind_ref:
    ...
    name = 'veela_single_125_kw_gen_265_mm_u_ref_' + str(w) + '_log_wind'
...
for w in wind_ref:
    ...
    name = 'veela_single_125_kw_gen_no_vsd_265_mm_u_ref_' + str(w) + '_log_wind'
...
for w in wind_ref:
    ...
    name = 'veela_single_125_kw_gen_265_mm_k_gear_opti_u_ref_' + str(w) + '_log_wind'
