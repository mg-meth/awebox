...
b_var = [5.5, 7.5, 10, 12.5, 15, 17.5, 20, 22.5, 25, 27.5, 30]
b_var = [12.5]
w = 7
wd = 1
n_k = 35
...
for b in b_var:
    ...
    name = 'veela_single_5_mw_gear_265_mm_u_ref_' + '7' + '_log_wind' + '_upscale_b_' + str(b) + '_n_k_' + str(n_k) + '_wd_' + str(wd) + 'invest'
