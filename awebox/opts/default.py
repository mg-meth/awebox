...
def set_default_options(default_user_options, help_options):
    ...
    default_options_tree = [
        ...
        ('model',   'tether', None,         'top_mass_alloc_frac',  1,        ('where to make a cut on a tether segment, in order to allocate tether mass to neighbor nodes, as fraction of segment length, measured from top', None), 'x'),
        ...
        ('model', 'ground_station', None, 'ddl_t_max',        2,    ('reel-in/out acceleration limit on the tether [m/s^2]', None),'x'),
